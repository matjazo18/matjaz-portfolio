...
const soicals = [
  {
    ...
    icon: (
      <svg
        ...
        className="size-6"
      >
        <path d="M 11.5 6 C 8.4802259 6 6 8.4802259 6 11.5 L 6 36.5 C 6 39.519774 8.4802259 42 11.5 42 L 36.5 42 C 39.519774 42 42 39.519774 42 36.5 L 42 11.5 C 42 8.4802259 39.519774 6 36.5 6 L 11.5 6 z M 11.5 9 L 36.5 9 C 37.898226 9 39 10.101774 39 11.5 L 39 36.5 C 39 37.898226 37.898226 39 36.5 39 L 11.5 39 C 10.101774 39 9 37.898226 9 36.5 L 9 11.5 C 9 10.101774 10.101774 9 11.5 9 z M 15 13 C 13.343 13 12 14.343 12 16 C 12 17.657 13.343 19 15 19 C 16.657 19 18 17.657 18 16 C 18 14.343 16.657 13 15 13 z M 12 21 L 12 35 L 18 35 L 18 21 L 12 21 z M 21 21 L 21 35 L 27 35 L 27 27.5 C 27 26.119 28.119 25 29.5 25 C 30.881 25 32 26.119 32 27.5 L 32 35 L 38 35 L 38 26.5 C 38 23.467 35.533 21 32.5 21 C 30.748 21 29.182 21.82 28.123 23.088 L 27 21 L 21 21 z"></path>
      </svg>
    ),
    path: "https://www.linkedin.com/in/matja%C5%BE-gazvoda-29b354322/",
  },
  {
    name: "Github",
    icon: (
